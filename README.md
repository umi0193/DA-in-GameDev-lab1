...
### 1) Что произойдёт с координатами объекта, если он перестанет быть дочерним?
 ...
 | Основной | {0;0;2} | {0;0;0} |
 | Дочерний |  {0;0;2} | {0;0;0} |
 | Незаисимый | {0;0;2} | {0;0;0} |
...
При проведением эксперимента с кубом и сферой было выяснено следующее:
 ...
 [Ось координат и передвижение куба(сфера дочерняя)]()
 [Ось координат и передвижение сферы(сфера дочерняя)]()
